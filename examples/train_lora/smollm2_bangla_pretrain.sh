...
# SmolLM2-135M Bangla Pre-training with LoRA using LLaMA-Factory
...
OUTPUT_DIR=${OUTPUT_DIR:-./saves/smollm2-135m/lora/bangla_pretrain}
...
output_dir = os.environ.get("OUTPUT_DIR", "./saves/smollm2-135m/lora/bangla_pretrain")
...
echo "[3/4] Starting pre-training with LLaMA-Factory"
